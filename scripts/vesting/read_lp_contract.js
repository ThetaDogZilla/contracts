...
const readVestingContract = async () => {
  ...
  console.log("Vesting total amount: " + total/BigInt(1e18) + " DOGZ");
  ...
  for (let i = 0; i < count; i++) {
    ...
    console.log("Vesting releasable amount: " + releasable/BigInt(1e18)+ " DOGZ");
    ...
    console.log("Total amount: "+ schedule[6]/BigInt(1e18) + " DOGZ");
    console.log("Released: "+ schedule[7]/BigInt(1e18) + " DOGZ");
